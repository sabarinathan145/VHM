...
<center>
    ...
    <h2>Admin Updation Form</h2>

    <div class="main">
    <div class="register">
        
        <form id="register" method="POST" action="{{route('update',$disp->UHID) }}">
            {{ csrf_field()}}
            
            <div id="left">
             <label>Date: </label>
                <input type="Date" name="date" id="date" style="border-radius: 10px;" value="{{ $disp->DATE }}" required>
</div>
<div id="right">
            <label>Time: </label>
                <input type="time" name="time" id="time" style="border-radius: 10px;" value="{{ $disp->TIME }}" required>
</div>
            <br><br><br><br><br>
            <div id="left">
            <label>Name  </label>
               &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp: <input type="text" name="fname" id="name" placeholder="Enter your name" style="border-radius: 10px;"  maxlength="15" value="{{ $disp->NAME }}" required >
            </div>
            <div id="right">
            <label>Father/ Mother/Husband Name : </label>
                <input type="text" name="gname" id="name" placeholder="Enter your gaurdian name" style="border-radius: 10px;" maxlength="15" value="{{ $disp->GAURDAIN_NAME }}" required>
            </div>
            <br><br><br>
<div id="left">
            <label>Date of birth  </label>
		       &nbsp&nbsp&nbsp: <input type="Date" name="dob" id="dateofbirth" style="border-radius: 10px;" value="{{ $disp->DOB }}" required>
</div>
           
            <div id="right">

            &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<label>Religion : </label>
                <input type="text" name="religion" id="religion" placeholder="Enter your religion" style="border-radius: 10px;" maxlength="15" value="{{ $disp->RELIGION }}" required>
            
            </div>
             <div id="right">

            <label>Age : </label>
                &nbsp<input type="number" name="age" id="age" placeholder="Enter your age" style="border-radius: 10px;" maxlength="2" value="{{ $disp->AGE }}" required>
           </div> <br><br><br>
<div id="left">
           ...
           <div id="right1">
            ...
            <label>Address : </label><br><br>
               <textarea name="address" class="three" style="border-radius: 10px;" maxlength="100" value="{{ $disp->ADDRESS }}" required></textarea>

            <br><br><br>
 <div id="left">
            <label>City  </label>
                &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp: <input type="text" name="city" id="city" placeholder="Enter your city" style="border-radius: 10px;" maxlength="15" value="{{ $disp->CITY }}" required>
</div>
            <div id="right">
                ...
                <label>State : </label>
                    <input list="state" name="state" placeholder="select your state" style="border-radius: 10px;" value="{{ $disp->STATE }}" required/>
                    <datalist id="state">
...
<div id="left">
            <label>Pincode  </label>
                ...
                &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp: <input type="number" name="pincode" id="pincode" placeholder="Enter your pincode" style="border-radius: 10px;" maxlength="6" value="{{ $disp->PINCODE }}" required>
            </div>

            <div id="right">

            &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<label>Landmark : </label>
                <input type="text" name="landmark" id="Landmark" placeholder="Enter your landmark" style="border-radius: 10px;" maxlength="15" value="{{ $disp->LANDMARK }}" required>
</div>
<div id="right">
            <label>Mobile</label>
                &nbsp:&nbsp<input type="number" name="phonenumber" id="pnumber" placeholder="Enter your phonenumber" style="border-radius: 10px;" maxlength="10" value="{{ $disp->MOBILE }}" required>
            ...
            <label>Height(in cm) : </label>
                <input type="number" name="height" id="height" class="reading" style="border-radius: 10px;" maxlength="4" value="{{ $disp->HEIGHT }}" required> 
             &nbsp&nbsp&nbsp&nbsp&nbsp &nbsp&nbsp&nbsp&nbsp&nbsp<label>Weight(in kg) : </label>
               <input type="number" name="weight" id="Weight" class="reading" style="border-radius: 10px;" maxlength="4" value="{{ $disp->WEIGHT }}" required>  
            &nbsp&nbsp&nbsp&nbsp&nbsp &nbsp&nbsp&nbsp&nbsp&nbsp<label>Blood Pressure : </label>
                <input type="number" name="bp" id="bp" class="reading" style="border-radius: 10px;" maxlength="4" value="{{ $disp->BP }}" required>  
            &nbsp&nbsp&nbsp&nbsp&nbsp &nbsp&nbsp&nbsp&nbsp&nbsp<label>Pulse : </label>
                <input type="number" name="pulse" id="pulse" class="reading" style="border-radius: 10px;" maxlength="4" value="{{ $disp->PULSE }}" required> <br><br>  
            <label>Temp(in F) : </label>
                <input type="number" name="Temp" id="Temprature" class="reading" style="border-radius: 10px;" maxlength="4" value="{{ $disp->TEMP }}" required>  
            &nbsp&nbsp&nbsp&nbsp&nbsp &nbsp&nbsp&nbsp&nbsp&nbsp<label>Sugar : </label>
                <input type="number" name="sugar" id="sugar" class="reading" style="border-radius: 10px;" maxlength="4" value="{{ $disp->SUGAR }}" required>  <br><br><br>
                <label>Cheif Complaints : </label><br><br>
               <textarea name="complaints" class="three" style="border-radius: 10px;" maxlength="100" value="{{ $disp->CHEIF_COMPLAINTS }}" required></textarea>

            <br><br><br>

            <label>Department : </label>
                <input type="number" name="Department" id="Department" style="border-radius: 10px;" maxlength="3" value="{{ $disp->DEPARTMENT }}" required>  
